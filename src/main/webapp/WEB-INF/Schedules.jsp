        ...
        <table border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <%=(user.getAccessLevel().getLevel() >= 2) ? "<td><a href='./UpdateSchedule?id=" + hall.getHallId() + "'>Update</a></td>" : ""%>
                    <%=(user.getAccessLevel().getLevel() >= 2) ? "<td><a href='./DeleteSchedule?id=" + hall.getHallId() + "'>Delete</a></td>" : ""%>
                </tr>
                <%
                }
                %>
